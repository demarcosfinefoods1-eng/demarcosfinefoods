...
export function Header() {
  ...
  return <><a className="skip-link" href="#main-content">Skip to Main Content</a><header className="site-header"><div className="shell header-inner">
    <Link to="/" className="brand" aria-label="DeMarco's Fine Foods home"><img className="brand-logo" src={`${import.meta.env.BASE_URL}brand/logo-nav.svg`} alt="DeMarco's Fine Foods" width="860" height="560" /></Link>
