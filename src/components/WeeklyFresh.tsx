...
export function WeeklyFresh() {
  return <section className="section weekly-section" aria-labelledby="weekly-title"><div className="shell">
    <div className="weekly-heading"><SectionHeading eyebrow="In store now" title="What's Fresh This Week" body="Seasonal favourites change quickly and are available while supplies last. Stop in today for the best selection." /><a href={store.directionsUrl} target="_blank" rel="noreferrer">Get directions for today's best picks <ArrowRight size={18} /></a></div>
