...
export default function GiftBasketsPage() {
  ...
  </main><footer><div className="shell footer-bottom gift-page-footer"><Link to="/" className="gift-page-footer-logo" aria-label="DeMarco's Fine Foods home"><img src="/demarcosfinefoods/brand/logo-dark.svg" alt="DeMarco's Fine Foods" width="1100" height="700" /></Link><span>© {new Date().getFullYear()} DeMarco's Fine Foods</span><Link to="/">Return to the homepage</Link></div></footer><MobileActions /></>
}
