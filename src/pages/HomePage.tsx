...
export default function HomePage() {
  ...
  </main><footer><div className="shell footer-grid"><div><a href="#main-content" className="brand footer-brand"><span className="brand-mark">D</span><span>DeMarco's<small>Fine Foods</small></span></a><p>Fresh food and friendly service, right in your Windsor neighbourhood.</p></div><div><h3>Visit</h3><a href={store.directionsUrl} target="_blank" rel="noreferrer">1349 Grand Marais Rd W<br />Windsor, ON N9E 1E2</a><a href={store.phoneHref}>{store.phoneDisplay}</a></div><div><h3>Hours</h3><p>Monday–Saturday<br />10 AM–8 PM</p><p>Sunday<br />11 AM–4 PM</p></div></div><div className="shell footer-bottom"><span>© {new Date().getFullYear()} DeMarco's Fine Foods</span><span>Proudly serving Windsor, Ontario</span></div></footer><MobileActions /></>
}
